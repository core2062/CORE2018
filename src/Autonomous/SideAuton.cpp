...
SideAuton::SideAuton() :
	...
	m_moveToSwitch = new Node(5, new DriveDistanceAction()), new liftAction(liftAction::SWITCH);
	...
	m_moveToScale = new Node(5, new DriveDistanceAction()), new LiftAction(liftAction::SCALE);
